...
<div class="panel panel-default" id="main" >
	...
	<form action="${pageContext.request.contextPath}/ssJob.do" method="post">
        ...
        <a href="${pageContext.request.contextPath}/web/addjob.jsp" class="button">我要招聘</a>
        <a href="${pageContext.request.contextPath}/web/addjob.jsp" class="button">我要求职</a>
        </form>
    </div>
    ...
    <li class="list-group-item">
        <div style="height: 50px">
            <div style="width: 89%;float: left">
                <a href="${pageContext.request.contextPath}/showReply/${job.mid}.do">${job.mtopic}</a><br/>
                <div>
                    <a><span class="label label-default" >${job.realName}</span></a>&nbsp;&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/showReply/${job.mid}.do"><span ><strong>${job.mcet}</strong></span></a>&nbsp;&nbsp;&nbsp;
                    <small class="text-muted">${job.mtime}</small>
                </div>
            </div>
            <div style="width: 5%;float: right;text-align: center">
                <span class="badge">求职招聘</span>
            </div>
        </div>
    </li>
    </c:forEach>
