...
<body>
<input type="hidden" id="old" value="${user.pwd}"/>
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 修改用户密码</strong></div>
  <div class="body-content">
    <form method="post" id="frm" class="form-x" action="${pageContext.request.contextPath}/updatePwd.do" target="_parent" onsubmit="return vaildate();">
