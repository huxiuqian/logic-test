...
<div class="panel panel-default" id="main" >
	...
	<form action="${pageContext.request.contextPath}/ssChat.do" method="post">
        ...
        <a href="${pageContext.request.contextPath}/web/addchat.jsp" class="button">我要发贴</a>
        </form>
    </div>
    ...
    <li class="list-group-item">
        <div style="height: 50px">
            <div style="width: 89%;float: left">
                <a href="${pageContext.request.contextPath}/showReply/${chat.mid}.do">${chat.mtopic}</a><br/>
                <div>
                    <a><span class="label label-default" >${chat.realName}</span></a>&nbsp;&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/showReply/${chat.mid}.do"><span ><strong>${chat.mcet}</strong></span></a>&nbsp;&nbsp;&nbsp;
                    <small class="text-muted">${chat.mtime}</small>
                </div>
            </div>
            <div style="width: 5%;float: right;text-align: center">
                <span class="badge">聊天灌水</span>
            </div>
        </div>
    </li>
    </c:forEach>
